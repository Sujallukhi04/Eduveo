...
const GroupSidebar = ({
  ...
  <aside className="w-full md:w-80 flex-shrink-0 bg-white dark:bg-gray-800 border-r dark:border-gray-700 flex flex-col h-full">
    <div className="p-4 border-b dark:border-gray-700">
      <Link
        href="/groups"
        className="inline-flex items-center text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 mb-2"
      >
      ...
      const fetchGroupDetails = async () => {
        ...
        try {
          ...
          if (data.pinnedMessageId) {
            const foundPinned = data.messages.find(
    ...
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      <div className="hidden md:flex h-full">
        <GroupSidebar
          group={group}
          isOwner={isOwner}
          handleDeleteOrLeave={handleDeleteOrLeave}
        />
      </div>
